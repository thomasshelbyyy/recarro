...
const Home = ()=> {
    ...
    return(
        <div style={background} className="flex flex-col items-center pb-10">
            <div className="flex flex-col md:flex-row py-20 justify-center items-center  text-slate-800 gap-10" >
            ...
            <a href="" className="px-3 py-2 text-2xl text-white bg-sky-700 rounded-full ">Get Started</a>
        </div>
    )
}
